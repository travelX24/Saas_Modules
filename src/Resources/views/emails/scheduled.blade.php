    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">
                {{ tr('View and manage scheduled email campaigns') }}
            </p>
        </div>
...
(function() {
    function convertSentTime() {
        // Convert only "Sent At" times to device timezone
        document.querySelectorAll('.sent-time[data-utc-time]').forEach(function(element) {
            ...
            if (utcTime && utcTime.trim() !== '') {
                try {
                    ...
                    // Format: YYYY-MM-DD HH:MM (in device timezone)
